...
//       {"topic_fisheye_pose",
//        std::bind(&Recorder::MsgHandler<pb::fisheye_msgs::PoseMessage>,
//        recorder,
...
//   recorder_handler_map.insert(
//       {"/vehicle/gps/fix",
//        std::bind(&Recorder::MsgHandler<pb::car_info_msgs::NavSatFix>,
//        recorder,
...
//                  recorder, "/vehicle/throttle_report",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
//       {"/vehicle/steering_report",
//        std::bind(&Recorder::MsgHandler<pb::car_info_msgs::SteeringReport>,
//                  recorder, "/vehicle/steering_report",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
//       {"/vehicle/twist",
//        std::bind(&Recorder::MsgHandler<pb::geometry_msgs::TwistStamped>,
...
//                  recorder, "/vehicle/surround_report",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
//       {"/vehicle/sonar_cloud",
...
//                  recorder, "/vehicle/vehicle_state",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
//       {"/vehicle/dbw_enabled",
...
//        std::bind(&Recorder::MsgHandler<pb::car_info_msgs::JointState>,
//        recorder,
...
//   recorder_handler_map.insert(
//       {"/vehicle/brake_cmd",
//        std::bind(&Recorder::MsgHandler<pb::car_info_msgs::BrakeCmd>,
//        recorder,
...
//                  recorder, "/vehicle/turn_signal_cmd",
//                  std::placeholders::_1)});
...
//   recorder_handler_map.insert(
//       {"/tf",
//       std::bind(&Recorder::MsgHandler<pb::world_model_msgs::TFMessage>,
...
//        std::bind(&Recorder::MsgHandler<pb::world_model_msgs::WaypointCell>,
//                  recorder, "ref_waypoint_cent_lane",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
...
//   recorder_handler_map.insert(
//       {"debug1", std::bind(&Recorder::MsgHandler<pb::std_msgs::Int8>,
//       recorder,
...
//                  recorder, "current_follower_method",
//                  std::placeholders::_1)});
//   recorder_handler_map.insert(
//       {"follower_target",
...
//   recorder_handler_map.insert(
//       {"state", std::bind(&Recorder::MsgHandler<pb::std_msgs::String>,
//       recorder,
...
//        std::bind(&Recorder::MsgHandler<pb::world_model_msgs::Marker>,
//        recorder,
...
//   player_handler_map.insert(
//       {"/mobileye/parsed_tx/lane_detail",
//        std::bind(&Player::MsgHandler<pb::esr_mobileye_msgs::LaneDetail>,
//        Player,
...
//   player_handler_map.insert(
//       {"/vehicle/gps/vel",
//        std::bind(&Player::MsgHandler<pb::geometry_msgs::TwistStamped>,
//        Player,
//                  "/vehicle/gps/vel", std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/vehicle/gps/time",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::TimeReference>,
//        Player,
...
//   player_handler_map.insert(
//       {"/vehicle/throttle_report",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::ThrottleReport>,
//        Player,
//                  "/vehicle/throttle_report", std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/vehicle/steering_report",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::SteeringReport>,
//        Player,
...
//                  Player, "/vehicle/suspension_report",
//                  std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/vehicle/tire_pressure_report",
...
//                  Player, "/vehicle/fuel_level_report",
//                  std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/vehicle/surround_report",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::SurroundReport>,
//        Player,
...
//                  Player, "/vehicle/brake_info_report",
//                  std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/vehicle/throttle_info_report",
...
//   player_handler_map.insert(
//       {"/vehicle/vehicle_state",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::VehicleState>,
//        Player,
...
//   player_handler_map.insert(
//       {"/vehicle/turn_signal_cmd",
//        std::bind(&Player::MsgHandler<pb::car_info_msgs::TurnSignalCmd>,
//        Player,
...
//   player_handler_map.insert(
//       {"/gnss_stat", std::bind(&Player::MsgHandler<pb::std_msgs::Bool>,
//       Player,
...
//                  Player, "/predict/obstacle_predict",
//                  std::placeholders::_1)});
//   player_handler_map.insert(
//       {"/odom/current_pose",
//        std::bind(&Player::MsgHandler<pb::geometry_msgs::PoseStamped>, Player,
...
//   player_handler_map.insert(
//       {"camera_info",
//        std::bind(&Player::MsgHandler<pb::world_model_msgs::SpeedLimit>,
//        Player,
...
//   player_handler_map.insert(
//       {"/cross_road",
//        std::bind(&Player::MsgHandler<pb::world_model_msgs::CrossRoad>,
//        Player,
...
//   player_handler_map.insert(
//       {"human_help_request",
//        std::bind(&Player::MsgHandler<pb::world_model_msgs::HumanHelp>,
//        Player,
...
//   player_handler_map.insert(
//       {"final_waypoints",
//        std::bind(&Player::MsgHandler<pb::world_model_msgs::Trajectory>,
//        Player,
...
//   player_handler_map.insert(
//       {"/planning/global_viapoints",
//        std::bind(&Player::MsgHandler<pb::parking_msgs::GlobalViapoints>,
//        Player,
...
//   player_handler_map.insert(
//       {"/car_pose",
//       std::bind(&Player::MsgHandler<pb::world_model_msgs::Marker>,
